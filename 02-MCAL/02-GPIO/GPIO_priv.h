...
#define GPO_PUSHPULL_CNF_MODE_ONES		((u8) 0x01)
#define GPO_PUSHPULL_CNF_MODE_ZEROS		((u8) 0x0E)

#define GPO_OPEN_DRAIN_CNF_MODE_ONES	((u8) 0x05)
#define GPO_OPEN_DRAIN_CNF_MODE_ZEROS	((u8) 0x0A)

#define AFO_PUSHPULL_CNF_MODE_ONES		((u8) 0x09)
#define AFO_PUSHPULL_CNF_MODE_ZEROS		((u8) 0x06)

#define AFO_OPEN_DRAIN_CNF_MODE_ONES	((u8) 0x0D)
#define AFO_OPEN_DRAIN_CNF_MODE_ZEROS	((u8) 0x02)

#define INPUT_ANALOG_CNF_MODE_ONES 		((u8) 0x00)
#define INPUT_ANALOG_CNF_MODE_ZEROS		((u8) 0x0F)

#define INPUT_FLOATING_CNF_MODE_ONES	((u8) 0x04)
#define INPUT_FLOATING_CNF_MODE_ZEROS	((u8) 0x0B)

#define INPUT_PULLDOWN_CNF_MODE_ONES	((u8) 0x08)
#define INPUT_PULLDOWN_CNF_MODE_ZEROS	((u8) 0x07)

#define INPUT_PULLUP_CNF_MODE_ONES		((u8) 0x08)
#define INPUT_PULLUP_CNF_MODE_ZEROS		((u8) 0x07)
